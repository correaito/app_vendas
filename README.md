...
![imagem](https://img.shields.io/badge/-Python-orange) ![imagem](https://img.shields.io/badge/-Kivy-black) ![imagem](https://img.shields.io/badge/-Firebase-yellow)
...
- [Kivy](https://kivy.org/doc/stable/ "Heading link")
- [Firebase](firebase.google.com "Heading link")
...
Da sua linha de comando:
    ...
    $ git clone https://github.com/correaito/app_vendas.git
...
* Obs.: Em breve irei disponibilizar mais informações sobre esse projeto nesse arquivo. Aguardem!
